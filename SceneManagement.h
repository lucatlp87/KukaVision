...
public:
	...
	std::vector<Object> GetInObjectsVector();
	// Get <out_objects_vector> attribute
	std::vector<Object> GetOutObjectsVector();
	...
	void VisualizeRefScene(std::vector<Cloud, Eigen::aligned_allocator<Cloud> > clusters_vector);
};
