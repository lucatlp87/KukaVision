...
public:
	...
	void UpdateInnerObjectsVector(int index_to_search, Eigen::Matrix4f pose, pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_to_set);
	// Update the outer objects vector
	void UpdateOuterObjectsVector(int index_to_search, Eigen::Matrix4f pose, pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_to_set);
