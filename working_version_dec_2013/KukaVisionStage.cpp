...
KukaVisionStage::RunStage()
{
    ...
    pcl::console::print_error("*************************************************\n");
	  ...
	  pcl::io::loadPCDFile("real_scanner/scenes/scene_funnelbig_glass.pcd",*kinect_acquisition);
...
>>>>>>> c0078ba5d23d49eecb39a09b9d75f77e4a19ecbf
                            {
                                if (current_match.second[0] > best_match_percentage)
                                {
                                    // Update the best match percentage value
                                    best_match_percentage = current_match.second[0];
...
<<<<<<< HEAD
                current_obj_pose = current_pose[best_match_smooth_idx].inverse()*T_cf;
=======
...
>>>>>>> c0078ba5d23d49eecb39a09b9d75f77e4a19ecbf
            ...
            else 
            {
                ...
                scene_object.UpdateOuterObjectsVector(-1, current_pose[0], current_cluster);
            }
